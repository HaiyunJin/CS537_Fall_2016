...
badd +0 user/usys.S
badd +0 user/user.h
badd +0 kernel/sysproc.c
badd +0 kernel/sysfunc.h
badd +0 kernel/syscall.c
badd +80 kernel/proc.h
badd +0 include/syscall.h
badd +0 include/pstat.h
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 108 - ((28 * winheight(0) + 22) / 45)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
108
normal! 0
tabedit include/syscall.h
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
