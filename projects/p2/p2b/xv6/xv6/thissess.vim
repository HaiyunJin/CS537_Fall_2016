...
set shortmess=aoO
badd +16 user/spin.c
badd +4 user/getpinfotest.c
badd +4 kernel/proc.c
badd +1 kernel/vm.c
badd +6 kernel/swtch.S
badd +103 ~/private/cs537/projects/p2/p2b/xv6/xv6/kernel/trap.c
badd +224 ~/.vimrc
badd +1 kernel/proc.h
args kernel/proc.c
edit kernel/proc.c
...
silent! normal! zE
let s:l = 15 - ((11 * winheight(0) + 15) / 31)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
15
normal! 0
tabedit ~/private/cs537/projects/p2/p2b/xv6/xv6/kernel/trap.c
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 104 - ((23 * winheight(0) + 15) / 31)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
104
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 83 - ((7 * winheight(0) + 15) / 31)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
83
