...
badd +26 kernel/sysfunc.h
badd +88 kernel/sysproc.c
badd +101 kernel/sysfile.c
args kernel/main.c
edit kernel/main.c
...
silent! normal! zE
let s:l = 65 - ((12 * winheight(0) + 15) / 31)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 391 - ((19 * winheight(0) + 15) / 31)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
391
normal! 017|
tabedit kernel/sysfile.c
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 68 - ((15 * winheight(0) + 15) / 31)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
68
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 108 - ((19 * winheight(0) + 15) / 31)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
108
