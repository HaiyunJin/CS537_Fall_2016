...
set shortmess=aoO
badd +14 user/usertests.c
badd +1 user/shmgetattest.c
badd +1 user/ls.c
badd +1 p1bdiff.out
badd +1 user/user.h
badd +1 user/usys.S
badd +1 include/syscall.h
badd +1 kernel/syscall.c
args user/shmgetattest.c
edit user/shmgetattest.c
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 47 - ((30 * winheight(0) + 15) / 31)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
47
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 106 - ((13 * winheight(0) + 15) / 31)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
106
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 33 - ((30 * winheight(0) + 15) / 31)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
33
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 33 - ((11 * winheight(0) + 15) / 31)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
33
